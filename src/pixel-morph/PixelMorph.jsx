...
const PixelMorph = () => {
  ...
  return (
    <div ref={sliderRef} className="overflow-hidden mt-2">
      <main className="relative w-full h-[36rem] overflow-hidden">
        <div
          id="slider"
          className="w-full h-[40rem] max-w-[1000px] relative mx-auto overflow-hidden border border-gray-800 shadow-2xl k"
        >
